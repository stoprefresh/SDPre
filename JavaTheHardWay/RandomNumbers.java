public class RandomNumbers {
  public static void main(String[] args) {
    ...
    rps = Math.random();
    if (rps < 0.3333333) { // will be true 1/3 f the time
    ...
    //pick four random intergers, each 1-6
    ...
    // pick aa single random integer, 1-100
    a = 1 + (int)(100 * Math.random());
    System.out.println("1-100: \t" + a + "\t" + a + "\t" + a + "\t" + a);

    // pick four random integers each, each 1-100
    a = 1 + (int)(100 * Math.random());
